...
---@param setting boolean @must be a boolean. Default: true.
...
--- The current setting is always returned, and is only updated when an argument is provided.
---
---@param depth number @must be a positive integer. Default: 1000.
...
--- - boolean, lightuserdata (NULL value only), nil, number, string, table
---
--- The remaining Lua types will generate an error:
--- - function, lightuserdata (non-NULL values), thread, userdata
---
...
--- The current setting is always returned, and is only updated when an argument is provided.
---
---@param setting boolean @must a boolean or "null". Default: false.
...
--- The current setting is always returned, and is only updated when an argument is provided.
---
---@param keep boolean @must be a boolean. Default: true.
...
--- The current setting is always returned, and is only updated when an argument is provided.
---
---@param precision number @must be an integer between 1 and 14. Default: 14.
...
---
---@param convert boolean @must be a boolean. Default: false.
---@param ratio number @must be a positive integer. Default: 2.
---@param safe number @must be a positive integer. Default: 10.
